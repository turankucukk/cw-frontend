    ...
    <Container maxWidth="lg" disableGutters sx={{ px: { xs: 1.5, sm: 2, md: 3 }, py: 2 }}>
      ...
      {tab === 0 && (
        <Box>
          ...
          <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 1.5, mt: 3 }}>
        ...
        <Grid container spacing={{ xs: 2, sm: 3 }}>
          {[
            ...
            <Grid size={{ xs: 12, sm: 6, md: 4 }} key={card.label}>
              <Card variant="outlined" sx={{ p: { xs: 2, sm: 3 }, borderRadius: 2 }}>
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <Box>
                    <Typography sx={{ fontSize: { xs: 24, sm: 28 }, fontWeight: 700, color: "#111827" }}>
                      {card.value}
                    </Typography>
