...
const MOCK_SUMMARY = {
  activeUsers: {
    value: 42,
    trend: [30, 33, 31, 38, 36, 40, 42],
    change: "+8.2%",
  },
  totalUsers: {
    value: 137,
    trend: [110, 115, 119, 124, 128, 133, 137],
    change: "+12.5%",
  },
  avgOccupancy: {
    value: 61,
    trend: [55, 58, 54, 60, 57, 63, 61],
    change: "+4.1%",
  },
};
                ...
                >
                  <Avatar
                    sx={{
                      width: 34,
                      height: 34,
                      bgcolor: BRAND_COLORS[i % BRAND_COLORS.length],
                      fontSize: 14,
                    }}
                  >
                    {u.name.charAt(0)}
